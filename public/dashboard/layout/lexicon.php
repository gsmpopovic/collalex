				...
				<div class="card-header">
				  <h4 class="card-title">
					<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
					  <strong>aga</strong> [á.ga] 1. <em>noun</em> <sub>ENG</sub> morning, <sub>CEB</sub> buntag; 2. <em>verb</em> <sub>ENG</sub> be morning, <sub>CEB</sub> buntag
					</a>
				  </h4>
				</div>
					  ...
					  <form role="form">
						  ...
						  <div class="row">
							...
							<div class="col-sm-5">
							  <!-- text input -->
							  <div class="form-floating mb-3">
								<input type="email" class="form-control" id="floatingInput" placeholder="Spelling of word" value="á.ga">
				...
				<div class="card-header">
				  <h4 class="card-title">
					<a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
					  <strong>kalabira</strong> [ka.la.bí.ra] <em>noun</em> <sub>ENG</sub> [empty], <sub>CEB</sub> [empty]
					</a>
				  </h4>
				</div>
				...
				<div class="card-header">
				  <h4 class="card-title">
					<a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
					  <strong>agigising</strong> [a.gi.gí.siŋ] <em>noun</em> <sub>ENG</sub> [empty], <sub>CEB</sub> [empty]
					</a>
				  </h4>
				</div>
